...
})({"706EL":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "93cca7947d2c7e20";
"use strict";
...
},{}],"hB9bE":[function(require,module,exports) {
...
var _handleInCheckPage = require("../components/userInfo/handleInCheckPage");
var _modal = require("../components/modal");
var _checkout = require("../components/checkout");
function checkout() {
    (0, _handleInCheckPage.handleInCheckPage)();
    (0, _handleProvinceDataDefault.default)();
    (0, _modal.modal)();
    (0, _checkout.purchase)();
}

},{"../components/address/handleProvinceData":"dvnnd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../components/modal":"Uilc0","../components/userInfo/handleInCheckPage":"arCWJ","../components/checkout":"6BmXf"}],"dvnnd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Uilc0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
function modal() {
    const modalOverlay = (0, _jqueryDefault.default)("#modal-overlay");
    const btnChange = (0, _jqueryDefault.default)(".change-address");
    ...
    modalOverlay.on("click", function(e) {
        if ((0, _jqueryDefault.default)(e.target).is("#modal-overlay")) modalOverlay.css("display", "none");
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","jquery":"hgMhh"}],"arCWJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleInCheckPage", ()=>handleInCheckPage);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _getUserInfoFromApi = require("./getUserInfoFromApi");
var _validatePhone = require("../validate/validatePhone");
var _validateFullName = require("../validate/validateFullName");
...
async function showInfoInCheckPage() {
    try {
        ...
        (0, _jqueryDefault.default)(".form-group").find("#full_name").val(receiverName);
        (0, _jqueryDefault.default)(".form-group").find("#user_phone").val(receiverPhone);
        (0, _jqueryDefault.default)(".form-group").find("#address").val(receiverAddress);
        updateUI();
    } catch (error) {
        console.log(error);
    }
...
function changeUserInfo() {
    validate();
    (0, _jqueryDefault.default)(".btn-save").on("click", function() {
        receiverName = (0, _jqueryDefault.default)("#full_name").val();
        receiverPhone = (0, _jqueryDefault.default)("#user_phone").val();
        receiverAddress = (0, _jqueryDefault.default)("#address").val();
        if ((0, _validateFullName.validateFullName)() && (0, _validatePhone.validatePhone)()) {
            (0, _jqueryDefault.default)("#modal-overlay").css("display", "none");
            updateUI();
        }
...
function updateUI() {
    (0, _jqueryDefault.default)("#receiver-name").text(receiverName);
    (0, _jqueryDefault.default)("#receiver-phone").text(receiverPhone);
    (0, _jqueryDefault.default)("#receiver-address").text(receiverAddress);
}
function capitalizeFirstLetter(str) {
    if (!str) return;
    else return str.split(" ").map(function(word) {
        return word.charAt(0).toUpperCase() + word.slice(1).toLowerCase();
    }).join(" ");
}

},{"jquery":"hgMhh","./getUserInfoFromApi":"eCCDf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../validate/validatePhone":"fJj5Y","../validate/validateFullName":"hJkA1"}],"fJj5Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6BmXf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function purchase() {
    (0, _jqueryDefault.default)(".btn-purchase").on("click", async function(e) {
        e.preventDefault();
        saveReceiverUserInfo();
        if (paymentMethod === "atm") checkoutByVNPay();
        else if (paymentMethod === "delivered") {
            if (confirm("You chose cash on delivery. Would you like to confirm this?")) window.location.href = "thanks";
        }
    });
}
//send receiver infomation (full_name, user_phone, address)
function saveReceiverUserInfo() {
    paymentMethod = (0, _jqueryDefault.default)("input[name='payment_method']:checked").val();
    fullName = (0, _jqueryDefault.default)(".identity #receiver-name").text();
    phoneReceiver = (0, _jqueryDefault.default)(".identity #receiver-phone").text();
    address = (0, _jqueryDefault.default)(".identity #receiver-address").text();
    localStorage.setItem("receiverInfo", JSON.stringify({
        fullName,
        phoneReceiver,
        address,
        paymentMethod
...
function checkoutByVNPay() {
    let amount = (0, _jqueryDefault.default)(".order-totals").find(".amount").text();
    ...
    (0, _jqueryDefault.default).ajax({
        ...
        success: function(response) {
            ...
            if (response.code === "00") window.location.href = response.data;
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["706EL"], null, "parcelRequire94c2")

//# sourceMappingURL=checkout.7d2c7e20.js.map
