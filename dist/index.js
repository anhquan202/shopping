...
function plusQuantity() {
    (0, _jqueryDefault.default)(".btn-plus").on("click", function(e) {
        e.preventDefault();
        var productId = (0, _jqueryDefault.default)(this).data("product-id");
        var product = (0, _jqueryDefault.default)("#product-" + productId);
...
function updatePriceItem(productElement) {
    var priceText = (0, _jqueryDefault.default)(productElement).find(".price_out").text();
    var price = parseFloat(priceText.replace(/,/g, ""));
    var quantityInput = parseInt((0, _jqueryDefault.default)(productElement).find('input[type="number"]').val());
    var total = price * quantityInput;
    (0, _jqueryDefault.default)(productElement).find(".products-price").html(total.toLocaleString());
}
function updateTotalPrice() {
    var total = 0;
    (0, _jqueryDefault.default)(".list-item .item").each(function() {
